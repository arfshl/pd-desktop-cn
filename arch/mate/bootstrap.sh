...
if [ "$ARCH" = "x86_64" ] || [ "$ARCH" = "i686" ]; then 
    proot-distro install docker.m.daocloud.io/archlinux/archlinux --name arch-mate
elif [ "$ARCH" = "aarch64" ] || [ "$ARCH" = "arm" ]; then 
    proot-distro install docker.m.daocloud.io/arfshl/archlinuxarm:latest --name arch-mate
else
