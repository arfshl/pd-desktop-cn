...
- proot-distro aliases: ubuntu-lts
      ...
      apt update && apt install wget -y && wget https://raw.githubusercontent.com/arfshl/pd-desktop-cn/refs/heads/main/ubuntu-lts/cli/bootstrap.sh && sh bootstrap.sh
...
#### Install
    apt update && apt install wget -y && wget https://raw.githubusercontent.com/arfshl/pd-desktop-cn/refs/heads/main/ubuntu-lts/xfce/bootstrap.sh && sh bootstrap.sh
...
#### Install
    apt update && apt install wget -y && wget https://raw.githubusercontent.com/arfshl/pd-desktop-cn/refs/heads/main/ubuntu-lts/lxqt/bootstrap.sh && sh bootstrap.sh
...
#### Install
    apt update && apt install wget -y && wget https://raw.githubusercontent.com/arfshl/pd-desktop-cn/refs/heads/main/ubuntu-lts/mate/bootstrap.sh && sh bootstrap.sh
...
#### Install
    apt update && apt install wget -y && wget https://raw.githubusercontent.com/arfshl/pd-desktop-cn/refs/heads/main/ubuntu-lts/lxde/bootstrap.sh && sh bootstrap.sh
...
#### Install
    apt update && apt install wget -y && wget https://raw.githubusercontent.com/arfshl/pd-desktop-cn/refs/heads/main/ubuntu-lts/cinnamon/bootstrap.sh && sh bootstrap.sh
...
#### Install
    apt update && apt install wget -y && wget https://raw.githubusercontent.com/arfshl/pd-desktop-cn/refs/heads/main/ubuntu-lts/kde/bootstrap.sh && sh bootstrap.sh
