...
#### Install
    apt update && apt install wget -y && wget https://raw.githubusercontent.com/arfshl/pd-desktop-cn/refs/heads/main/debian-sid/xfce/bootstrap.sh && sh bootstrap.sh
...
#### Install
    apt update && apt install wget -y && wget https://raw.githubusercontent.com/arfshl/pd-desktop-cn/refs/heads/main/debian-sid/lxqt/bootstrap.sh && sh bootstrap.sh
...
#### Install
    apt update && apt install wget -y && wget https://raw.githubusercontent.com/arfshl/pd-desktop-cn/refs/heads/main/debian-sid/mate/bootstrap.sh && sh bootstrap.sh
...
#### Install
    apt update && apt install wget -y && wget https://raw.githubusercontent.com/arfshl/pd-desktop-cn/refs/heads/main/debian-sid/lxde/bootstrap.sh && sh bootstrap.sh
...
#### Install
    apt update && apt install wget -y && wget https://raw.githubusercontent.com/arfshl/pd-desktop-cn/refs/heads/main/debian-sid/cinnamon/bootstrap.sh && sh bootstrap.sh
...
#### Install
    apt update && apt install wget -y && wget https://raw.githubusercontent.com/arfshl/pd-desktop-cn/refs/heads/main/debian-sid/kde/bootstrap.sh && sh bootstrap.sh
